define("app/base.js",[],function(e){function n(e){var n=document.createElement("iframe");n.src=e,n.style.display="none";var t=p();t&&(t.appendChild(n),setTimeout(function(){t.removeChild(n),n=null},500))}var t="ttpodsmm",a="js_request",c="app.",r="service",o="params",u="ack",l="callback",i="error",f="cancel",s="confirm",p=function(){var e;return function(){if(e)return e;var n=document.getElementsByTagName("body");return e=n&&n[0]}}(),m=function(e){var n=0;return function(){return e+n++}}((new Date).valueOf()+~~(1e8*Math.random())),d=function(){function e(e,n,t){return{fn:e,space:n,onlyone:t}}function p(n,t,a,c,r){switch(a){case l:h[n]=e(t,c,r);break;case i:k[n]=e(t,c,r);break;case f:b[n]=e(t,c,r);break;case s:g[n]=e(t,c,r);break;default:return null}}function d(e){delete e.fn,delete e.space,delete e.onlyone}function v(e){h[e]&&d(h[e]),delete h[e],k[e]&&d(k[e]),delete k[e],b[e]&&d(b[e]),delete b[e],g[e]&&d(g[e]),delete confirm[e]}function y(e,n,d){var y=[];y.push(r+"="+e),n&&y.push(o+"="+encodeURIComponent($.param(n))),d=d||{};var h=m();"function"==typeof d.callback&&(p(h,d.callback,l,d.space,d.onlyone),y.push(l+"="+c+l)),"function"==typeof d.error&&(p(h,d.error,i,d.space,d.onlyone),y.push(i+"="+c+i)),"function"==typeof d.cancel&&(p(h,d.cancel,f,d.space,d.onlyone),y.push(f+"="+c+f)),p(h,function(){d.confirm&&d.confirm.call(this),clearTimeout(k)},s,d.space,d.onlyone),y.push(s+"="+c+s);var k=setTimeout(function(){d.timeoutfn&&d.timeoutfn.call(d.space),v(h)},1e3*(d.timeout||30));return y.push(u+"="+h),{url:t+"://"+a+"?"+y.join("&"),ack:h}}var h={},k={},b={},g={},w=function(e,n,t){var a=e[n];t=[].slice.call(t,1),a&&(a.fn.apply(a.space||this,t),a.onlyone&&(delete e[n],a.fn=a.space=null))},T={};return T[l]=function(e){w(h,e,arguments)},T[i]=function(e){w(k,e,arguments)},T[f]=function(e){w(b,e,arguments)},T[s]=function(e){w(g,e,arguments)},window.app=T,{setProtocol:function(e){t=e},create:function(e,n,t){var a=m();return p(a,e,l,n,t),a},call:function(e,t){t=t||{};var a=y(e,t.params,t);return n(a.url),a.ack},del:function(e){v(e)}}}();return d});
