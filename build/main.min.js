...
define("model/model.js",["base/base","base/event","common/funs","storage/store"],function(t,e,s){function i(){}function r(t,e,s,i){if(!t.v){var a=this,o=function(){setTimeout(function(){t.v||r.call(a,t,e,s,i)},1e3*e)};this.request({success:function(){s.success&&s.success.apply(this,arguments)},error:function(){s.error&&s.error.apply(this,arguments)},abort:function(){s.abort&&s.abort.apply(this,arguments)},complete:function(){s.complete&&s.complete.apply(this,arguments),o()}},i)}}var a=t("base/base"),o=t("base/event"),n=t("common/funs"),h=t("storage/store"),u=0,c=1,l=2,f=function(){this.off("success"),this.off("error"),this.off("abort")},p=/\{[^\{\}]*\}/,m=o.extend({propertys:function(){this._xhr,this.type="post",this.getfields=[],this.pathfields=[],this.param=this.buildParam(),this.result=this.buildResult(),this.state=u},initialize:function(){},setType:function(t){this.type=t},fieldsGet:function(){return[]},buildBaseUrl:function(){throw"Please override the `buildBaseUrl` method"},buildUrl:function(){throw"Please override the `buildUrl` method"},buildParam:function(){throw"Please override the `buildParam` method"},buildResult:function(){throw"Please override the `buildResult` method"},ajaxRequest:function(){throw"Please override the `ajaxRequest(type,url)` method"},verifyData:function(t){return!0},getParam:function(t){return this.param instanceof h?t?this.param.getAttr(t):this.param.get():JSON.parse(JSON.stringify(this.param))},setParam:function(t,e){return"object"===a.type(t)?void a.each(t,function(t,e){this.setParam(e,t)},this):void(this.param instanceof h?this.param.setAttr(t,e):(this.param||(this.param={}),this.param[t]=e))},delParam:function(t){return"array"===a.type(t)?void a.each(t,function(t){this.delParam(t)},this):void(this.param instanceof h?this.param.delAttr(t):(this.param||(this.param={}),delete this.param[k]))},getResult:function(){if(this.result instanceof h){var t=this.getParam(),e=t?JSON.stringify(t):null;return this.result.get(e)}return this.result},setResult:function(t){if(this.result instanceof h){var e=this.getParam(),s=e?JSON.stringify(e):null;this.result.set(t,s)}},request:function(t,e){t=t||{};var s,r=t.success||i,o=t.error||i,h=t.abort||i,m=t.complete||i;if(this.state===l){if(s=this.getResult())return void r.call(e||this,s);this.state=u}if(this.state==l||(this.on("success",r,e),this.on("error",o,e),this.on("abort",h,e),this.on("complete",m,e),this.state!==c)){this.baseurl=this.buildBaseUrl(),this.url=this.buildUrl();var d=this.baseurl.replace(/\/+$/g,"")+"/"+this.url.replace(/^\/+/g,""),b=this.getParam()||{},v=this,g=[];if(this.type&&!this.type.match(/get/i)){var y=d.indexOf("?")>-1?"&":"?",P=function(t,e){var s=[];return"*"===t?a.each(e,function(t,e){s.push(e+"="+t)}):a.each(t,function(t){e[t]&&s.push(t+"="+e[t])}),s.join("&")}(this.fieldsGet(),b);P&&(d=(d+y+P).replace(/\?{2,}/i,"?").replace(/\?&+/i,"?"))}return d.match(p)&&(d=n.formatString(d,b||{},function(t){g.push(t)}),a.each(g,function(t){delete b[t]})),this.isAbort=!1,this.state=c,this._xhr=this.ajaxRequest(this.type,d,b,function(t){v.verifyData(t)?(v.setResult(t),v.emit("success",t),v.state=l):(v.emit("error",t),v.state=u),v.emit("complete"),f.call(v),this.isAbort=!1},function(t){this.isAbort?v.emit("abort",t):v.emit("error",t),v.emit("complete"),v.state=u,f.call(v),this.isAbort=!1}),this._xhr}},abort:function(){this._xhr&&(this.isAbort=!0,this._xhr.abort())},isLoopStop:{v:!1},loopRequest:function(t,e,s){"object"==typeof t&&(s=e,e=t,t=5),this.isLoopStop.v=!0,this.isLoopStop={v:!1},r.call(this,this.isLoopStop,t,e,s)},endLoopRequest:function(){this.isLoopStop.v=!0,this._xhr&&this._xhr.abort()}});return m});
...
define("ui/object.js",["base/base","ui/base","base/event","common/funs"],function(t){var i=t("base/base"),s=t("ui/base"),e=t("base/event"),n=t("common/funs"),o="ui-root",h=e.extend({propertys:function(){this.uiId=s.createUiId(),this.status=h.STATUS_NOT_CREATE,this.$el=null,this.useRoot=!0,this.container=null,this.__autoFnName=this.randFn(function(){this.emit("resize")})},initialize:function($super,t){$super(t),this.setOption(t)},setOption:function($super,t){t=t||{},$super(t),i.isNUL(t.useRoot)||(this.useRoot=t.useRoot),this.container=i.isNUL(t.container)?$("body"):t.container},randFn:function(t){var i=s.createFnName();return this[i]=t.bind(this),i},getUiId:function(){return this.uiId},create:function(){(this.status===h.STATUS_NOT_CREATE||this.status===h.STATUS_DESTROY)&&(this.useRoot?(this.$el=$('<div class="'+o+'" id="'+this.getUiId()+'"></div>'),this.$el.append(this.createHTML())):this.$el=$(this.createHTML()),this.$el.hide(),this.container.append(this.$el),this.status=h.STATUS_CREATE,this.emit("create"))},createHTML:function(){throw"error: not override createHTML"},show:function(){this.create(),(this.status===h.STATUS_CREATE||this.status===h.STATUS_SHOW||this.status===h.STATUS_HIDE)&&(this.$el.show(),this.status===h.STATUS_SHOW,this.emit("show"))},hide:function(){(this.status===h.STATUS_CREATE||this.status===h.STATUS_SHOW||this.status===h.STATUS_HIDE)&&(this.$el.hide(),this.status===h.STATUS_HIDE,this.emit("hide"))},topIndex:function(){this.$el&&this.$el.css("zIndex",s.createZIndex())},createDomId:function(t){return function(){return"comid-"+t()}}(n.createAddSelf()),destroy:function(){this.$el&&(this.$el.remove(),this.$el=null,this.status=h.STATUS_DESTROY,this.emit("destroy"))},startAutoPosition:function(){this[this.__autoFnName]&&$window.off("resize",this[this.__autoFnName]),$window.on("resize",this[this.__autoFnName])},endAutoPosition:function(){$window.off("resize",this[this.__autoFnName])}});return h.STATUS_NOT_CREATE=0,h.STATUS_CREATE=1,h.STATUS_SHOW=2,h.STATUS_HIDE=3,h.STATUS_DESTROY=4,h});
define("ui/slide.js",["ui/base","ui/object","base/base","common/funs"],function(t){function i(t){var i=$(x);return i.append(t),i}function s(){this.items&&d.each(this.items,function(t){this.add(t)},this),this.subbox=this.$el.find("."+l)}function e(){var t=this.$el.width(),i=this.$el.find("."+u),s=i.length*t;this.$el.find("."+l).css("width",s+"px"),i.width(t)}function n(){this.$el[0].addEventListener("touchstart",this,!1),this.$el[0].addEventListener("touchmove",this,!1),this.$el[0].addEventListener("touchend",this,!1)}var h=t("ui/base"),a=t("ui/object"),d=t("base/base"),o=(t("common/funs"),"ui-slide-box"),l="ui-slide-sub-box",u="ui-slide-item",c="ui-slide-trans",r="ui-slide-nav",f="ui-slide-cur-nav",x='<div class="'+u+'"></div>';return a.extend({propertys:function(){this.on("create",function(){this.$el.addClass(o),s.call(this),n.call(this),this.to(this.index)}),this.itemWidth=0,this.length=0,this.on("sizechange",function(){var t=this.$el.find("."+u);this.length=t.length}),this.on("show",function(){var t=this.$el.find("."+u);this.itemWidth=t.width(),this.startAutoPosition()}),this.on("hide",function(){this.endAutoPosition()}),this.on("resize",function(){e.call(this)}),this.items=[],this.index=0},createHTML:function(){return['<div class="'+l+'"></div>','<div class="'+r+'"></div>'].join("")},initialize:function($super,t){$super(t)},setOption:function($super,t){t=t||{},$super(t),t.items&&(this.items=t.items),t.index&&(this.index=t.index)},tx:0,dx:0,handleEvent:function(t){var i,s=t.changedTouches[0];switch(t.type){case"touchstart":this.subbox.removeClass(c),this.tx=s.pageX,this.dx=parseInt(h.getTranslate(this.subbox).x||0);break;case"touchmove":i=s.pageX-this.tx;var e=this.dx+i;e>0?e=0:e<-(this.itemWidth*Math.max(this.length-1,0))&&(e=-(this.itemWidth*Math.max(this.length-1,0))),h.setTranslate(this.subbox,{x:e+"px",y:"0px",z:"0px"});break;case"touchend":case"touchcancel":i=s.pageX-this.tx,this.subbox.addClass(c),setTimeout(function(){return Math.abs(i)<20?void h.setTranslate(this.subbox,{x:this.dx+"px",y:"0px",z:"0px"}):void(i>0?this.pre():this.next())}.bind(this),0)}},add:function(t,s){if(this.$el){var t=i.call(this,t);"number"==typeof s&&s!=0/0?0>s?this.$el.find("."+u).eq(0).before(t):this.$el.find("."+u).eq(s).after(t):this.$el.find("."+l).append(t);var e=this.createDomId();t.attr("id",e);var n=this.$el.find("."+r),h=$("<span></span>");h.attr("id","from-"+e),n.append(h),this.emit("sizechange")}},remove:function(t){if(this.$el){var i=this.$el.find("."+u).eq(t);i.length&&(i.remove(),this.emit("sizechange"))}},to:function(t){var i=0;t>=this.length&&(t=Math.max(this.length-1,0)),0>t&&(t=0),i=-(this.$el.width()*t),h.setTranslate(this.$el.find("."+l),{x:i+"px",y:"0px",z:"0px"});var s=this.$el.find("."+r).find("span").eq(t);s.addClass(f),s.siblings().removeClass(f),this.index=t},pre:function(){this.to(this.index-1)},next:function(){this.to(this.index+1)}})});
