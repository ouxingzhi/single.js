...
define("common/funs.js",["base/base"],function(n,e,r){var t=n("base/base"),i={};return i.createAddSelf=function(n){return n=n||0,function(){return n++}},i.createSingle=function(n){var e;return function(r){return e?e:e=new n(r)}},i.createDOM=function(n){return function(e){return n.append(e),n.children()}}($("<div></div>")),i.formatString=function(n,e,r,i,u){i||(i="{"),u||(u="}"),e=e||{},i="\\"+i.split("").join("\\"),u="\\"+u.split("").join("\\");var c=new RegExp(i+"([^"+i+u+"]*)"+u,"img");return n.replace(c,function(n,i){return t.isNUL(e[i])?"0":(r&&r(i),e[i])})},i});
