...
define("ui/base.js",["base/base","common/funs"],function(e,t,n){var r=(e("base/base"),e("common/funs")),o={};o.getOffsetByPage=function(e){var t=0,n=0;if(!e)return{left:t,top:n};do t+=e.offsetLeft,n+=e.offsetTop;while(e=e.offsetParent);return{top:n,left:t}},o.getPageSize=function(){return document.body?{height:document.body.scrollHeight,width:document.body.scrollWidth}:{width:0,height:0}},o.createZIndex=function(e,t){return function(){return t+e()}}(r.createAddSelf(),2e3),o.createUiId=function(e){return function(){return"uiId_"+e()}}(r.createAddSelf()),o.createFnName=function(e){return function(){return"fn_"+e()}}(r.createAddSelf()),o.cssPrefix=function(){return"webkitAudioContext"in window||"chrome"in window?"-webkit-":navigator.userAgent.match(/firefox/i)?"-moz-":""}();var i=/translate(x|y|z)\((-?[\w\.]+)\)/gim,s=/translate(?:3d|2d)?\(\s*(-?[\w\.]+)\s*,\s*(-?[\w\.-]+)\s*(?:,\s*(-?[\w\.-]+)\s*)?\)/i;return o.getTranslate=function(e){var t,n=$(e).css(o.cssPrefix+"transform"),r={};return n.match(i)?n.replace(i,function(e,t,n){r[t]=n}):(t=s.exec(n))&&(r.x=t[1],r.y=t[2],r.z=t[3]),console.log(r),r},o.setTranslate=function(e,t){var n=$(e);t=t||{};var r=[t.x||"0px",t.y||"0px",t.z||"0px"];n.css(o.cssPrefix+"transform","translate3D("+r.join(",")+")")},o});
