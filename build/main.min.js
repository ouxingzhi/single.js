...
define("model/model.js",["base/base","base/event","common/funs","storage/store"],function(t,e,i){function s(){}var r=t("base/base"),a=t("base/event"),h=t("common/funs"),n=t("storage/store"),o=0,u=1,l=2,c=function(){this.off("success"),this.off("error"),this.off("abort")},f=/\{[^\{\}]*\}/,m=a.extend({propertys:function(){this._xhr,this.type="post",this.getfields=[],this.pathfields=[],this.param=this.buildParam(),this.result=this.buildResult(),this.state=o},initialize:function(){},setType:function(t){this.type=t},fieldsGet:function(){return[]},buildBaseUrl:function(){throw"Please override the `buildBaseUrl` method"},buildUrl:function(){throw"Please override the `buildUrl` method"},buildParam:function(){throw"Please override the `buildParam` method"},buildResult:function(){throw"Please override the `buildResult` method"},ajaxRequest:function(){throw"Please override the `ajaxRequest(type,url)` method"},verifyData:function(t){return!0},getParam:function(t){return this.param instanceof n?t?this.param.getAttr(t):this.param.get():this.param},setParam:function(t,e){return"object"===r.type(t)?void r.each(t,function(t,e){this.setParam(e,t)},this):void(this.param instanceof n?this.param.setAttr(t,e):(this.param||(this.param={}),this.param[t]=e))},delParam:function(t){return"array"===r.type(t)?void r.each(t,function(t){this.delParam(t)},this):void(this.param instanceof n?this.param.delAttr(t):(this.param||(this.param={}),delete this.param[k]))},getResult:function(){if(this.result instanceof n){var t=this.getParam(),e=t?JSON.stringify(t):null;return this.result.get(e)}return this.result},setResult:function(t){if(this.result instanceof n){var e=this.getParam(),i=e?JSON.stringify(e):null;this.result.set(t,i)}else this.result=t},request:function(t,e){t=t||{};var i,a=t.success||s,n=t.error||s,m=t.abort||s;if(this.state===l){if(i=this.getResult())return void a.call(e||this,i);this.state=o}if(this.state==l||(this.on("success",a,e),this.on("error",n,e),this.on("abort",m,e),this.state!==u)){this.baseurl=this.buildBaseUrl(),this.url=this.buildUrl();var d=this.baseurl.replace(/\/+$/g,"")+"/"+this.url.replace(/^\/+/g,""),p=this.getParam(),b=this;if(this.type&&!this.type.match(/get/i)){var v=d.indexOf("?")>-1?"&":"?",g=function(t,e){var i=[];return"*"===t?r.each(e,function(t,e){i.push(e+"="+t)}):r.each(t,function(t){e[t]&&i.push(t+"="+e[t])}),i.join("&")}(this.fieldsGet(),p);g&&(d=(d+v+g).replace(/\?{2,}/i,"?").replace(/\?&+/i,"?"))}var P=[];return d.match(f)&&(d=h.formatString(d,p||{},function(t){P.push(t)}),r.each(P,function(t){delete p[t]})),this.isAbort=!1,this.state=u,this._xhr=this.ajaxRequest(this.type,d,p,function(t){b.verifyData(t)?(b.setResult(t),b.emit("success",t),b.state=l):(b.emit("error",t),b.state=o),c.call(b),this.isAbort=!1},function(t){this.isAbort?b.emit("abort",t):b.emit("error",t),b.state=o,c.call(b),this.isAbort=!1}),this._xhr}},abort:function(){this._xhr&&(this.isAbort=!0,this._xhr.abort())}});return m});
...
define("mvc/block.js",["base/base","common/funs","base/event"],function(t){function e(t){var e=(t||"").replace(/^\s+|\s+$/g,"").split(/\s+/);return{event:e.shift(),selector:e.join(" ")}}function s(t,s,n){t=t||{},i.each(t,function(t,o){var a=e(o),t=i.bind("function"==typeof t?t:noop,n||this);s.on(a.event,a.selector,t)},this)}var i=t("base/base"),n=t("common/funs"),o=t("base/event"),a=(n.createAddSelf(1500),"cur-block-view"),r="block-view";return o.extend({propertys:function(){this.frame,this.box,this.forward=!1,this.views={},this.transition=null},getPreFix:function(){return"block"},initialize:function($super,t){$super(t),this.setOption(t)},setOption:function(t){t=t||{},i.isNUL(t.box)||(this.box=t.box),i.isNUL(t.frame)||(this.frame=t.frame)},to:function(t,e){var i=this.getPreFix()+t,n=this.box.find("#"+i);if(n.length||(n=$('<div class="'+r+'" id="'+i+'"></div>'),this.box.append(n)),e.template){var o=e.data||{},f=_.template(e.template)(o);if(n.html(f),e.events&&(n.off(),s(e.events,n,e.space)),this.transition){var l=n.siblings("."+a);l.length?this.forward?this.transition.into(l,n,function(){l.removeClass(a),n.addClass(a)}):this.transition.out(l,n,function(){l.removeClass(a),n.addClass(a)}):n.addClass(a)}else n.siblings().removeClass(a),n.addClass(a)}},setForward:function(t){this.forward=t}})});
define("mvc/frame.js",["base/base","base/event","base/hash","base/promise","common/funs","common/url.hash","mvc/header","mvc/transition.default","ui/dialog","ui/toast","ui/loading"],function(i,t,e){var s=i("base/base"),a=i("base/event"),n=i("base/hash"),o=i("base/promise"),h=i("common/funs"),r=i("common/url.hash"),u=i("mvc/header"),c=i("mvc/transition.default"),d=i("ui/dialog"),f=i("ui/toast"),w=i("ui/loading"),l="single-frame-box",v="single-frame-head",m="single-frame-viewport",p="single-frame-foot",V=['<div class="'+l+'">','<div class="'+v+'"></div>','<div class="'+m+'">',"</div>",'<div class="'+p+'"></div>',"</div>"].join(""),g=h.createSingle(f),b=h.createSingle(d),x=h.createSingle(w),L=a.extend({propertys:function(){this.app,this.root=$(V),this.viewhead=this.root.find("."+v),this.viewport=this.root.find("."+m),this.viewfoot=this.root.find("."+p),this.header=new u({box:this.viewhead,frame:this}),this.name,this.views=new n,this.hashdata={},this.viewpath="./src/views",this.framebox,this.defaultView="index",this.transtion=c,this.lastView,this.curView},initialize:function($super,i){$super(),this.setOption(i),this.initDom()},setOption:function(i){s.isNUL(i.app)||(this.app=i.app),s.isNUL(i.name)||(this.name=i.name),s.isNUL(i.viewpath)||(this.viewpath=i.viewpath),s.isNUL(i.framebox)||(this.framebox=i.framebox),s.isNUL(i.defaultView)||(this.defaultView=i.defaultView),s.isNUL(i.transtion)||(this.transtion=i.transtion)},getRoot:function(){return this.root},initDom:function(){this.framebox.append(this.root)},hashChange:function(i){i.view||(i=r.parse(this.defaultView)),this.hashdata=i,this.header.setForward(this.hashdata.forward),this.toView(i.view,i)},toView:function(i,t){var e=this;this.getView(i,t).then(function(i,t,s){e.lastView=e.curView||s,e.curView=s,s.onLoad()})},turning:function(){this.curView===this.lastView?(this.curView.getRoot().show(),this.curView.onShow()):this.transferView(this.lastView,this.curView,function(){this.lastView.onHide(),this.curView.onShow()})},getView:function(i,t){var e=this.views.get(i),s=new o;return e?(e.setHashData(t),s.resolve(e)):this.loadView(i,function(e){if(!e)throw new Error("not found `"+i+".js`");var a=new e(i,t,this,this.app);this.viewport.append(a.getRoot()),a.emit("addframe"),this.views.push(i,a),a.onCreate(),s.resolve(a)}),s},loadView:function(i,t){var e=this.buildFullPath(i),s=this;seajs.use([e],function(i){t.call(s,i)})},getCurrentView:function(){return this.curView||this.lastView},buildFullPath:function(i){return(this.viewpath+"/"+i).replace(/\/+/g,"/")+".js"},transferView:function(i,t,e){this.hashdata.forward?this.transtion.into(i.getRoot(),t.getRoot(),function(){e.call(this)},this):this.transtion.out(i.getRoot(),t.getRoot(),function(){e.call(this)},this)},forward:function(i){var t=r.parse(i);t.frame&&t.frame!==this.name||this.hashChange(t)},back:function(){history.back()},toHead:function(i,t){this.header.to(i,t)},showToast:function(i,t,e){g().show({content:i,timeout:t,callback:e})},hideToast:function(){g().hide()},showAlert:function(i,t,e){b().show({title:e||"标题",content:i||"",buttons:t})},hideAlert:function(){b().hide()},showLoading:function(i){x().show({maskOpacity:i})},hideLoading:function(){x().hide()},showHeader:function(){this.header.show()},hideHeader:function(){this.header.hide()}});return L});
