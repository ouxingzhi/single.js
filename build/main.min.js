...
define("common/funs.js",["base/base"],function(n,e,r){var t=(n("base/base"),{});return t.createAddSelf=function(n){return n=n||0,function(){return n++}},t.createSingle=function(n){var e;return function(r){return e?e:e=new n(r)}},t});
...
define("mvc/block.js",["base/base","common/funs","base/event"],function(t){function s(t){var s=(t||"").replace(/^\s+|\s+$/g,"").split(/\s+/);return{event:s.shift(),selector:s.join(" ")}}function e(t,e,n){t=t||{},i.each(t,function(t,o){var a=s(o),t=i.bind("function"==typeof t?t:noop,n||this);e.on(a.event,a.selector,t)},this)}var i=t("base/base"),n=t("common/funs"),o=t("base/event"),a=(n.createAddSelf(1500),"cur-block-view"),r="block-view";return o.extend({propertys:function(){this.box,this.forward=!1,this.views={},this.transition=null},getPreFix:function(){return"block"},initialize:function($super,t){$super(t),this.setOption(t)},setOption:function(t){t=t||{},i.isNUL(t.box)||(this.box=t.box)},to:function(t,s){var i=this.getPreFix()+t,n=this.box.find("#"+i);if(n.length||(n=$('<div class="'+r+'" id="'+i+'"></div>'),this.box.append(n)),s.template){var o=s.data||{},l=_.template(s.template)(o);if(n.html(l),s.events&&(n.off(),e(s.events,n,s.space)),this.transition){var c=n.siblings("."+a);c.length?this.forward?this.transition.into(c,n,function(){c.removeClass(a),n.addClass(a)}):this.transition.out(c,n,function(){c.removeClass(a),n.addClass(a)}):n.addClass(a)}else n.siblings().removeClass(a),n.addClass(a)}},setForward:function(t){this.forward=t,console.log(this.forward)}})});
define("mvc/frame.js",["base/base","base/event","base/hash","base/promise","common/funs","common/url.hash","mvc/header","mvc/transition.default","ui/dialog","ui/toast","ui/loading"],function(t,i,e){var s=t("base/base"),a=t("base/event"),o=t("base/hash"),n=t("base/promise"),h=t("common/funs"),r=t("common/url.hash"),u=t("mvc/header"),f=t("mvc/transition.default"),c=t("ui/dialog"),d=t("ui/toast"),w=t("ui/loading"),l="fly-frame-box",v="fly-frame-head",m="fly-frame-viewport",p="fly-frame-foot",V=['<div class="'+l+'">','<div class="'+v+'"></div>','<div class="'+m+'">',"</div>",'<div class="'+p+'"></div>',"</div>"].join(""),b=h.createSingle(d),g=h.createSingle(c),x=h.createSingle(w),L=a.extend({propertys:function(){this.app,this.root=$(V),this.viewhead=this.root.find("."+v),this.viewport=this.root.find("."+m),this.viewfoot=this.root.find("."+p),this.header=new u({box:this.viewhead}),this.name,this.views=new o,this.hashdata={},this.viewpath="./src/views",this.framebox,this.defaultView="index",this.transtion=f,this.lastView,this.curView},initialize:function($super,t){$super(),this.setOption(t),this.initDom()},setOption:function(t){s.isNUL(t.app)||(this.app=t.app),s.isNUL(t.name)||(this.name=t.name),s.isNUL(t.viewpath)||(this.viewpath=t.viewpath),s.isNUL(t.framebox)||(this.framebox=t.framebox),s.isNUL(t.defaultView)||(this.defaultView=t.defaultView),s.isNUL(t.transtion)||(this.transtion=t.transtion)},getRoot:function(){return this.root},initDom:function(){this.framebox.append(this.root)},hashChange:function(t){t.view||(t=r.parse(this.defaultView)),this.hashdata=t,this.header.setForward(this.hashdata.forward),this.toView(t.view,t)},toView:function(t,i){var e=this;this.getView(t,i).then(function(t,i,s){e.lastView=e.curView||s,e.curView=s,s.onLoad()})},turning:function(){this.curView===this.lastView?(this.curView.getRoot().show(),this.curView.onShow()):this.transferView(this.lastView,this.curView,function(){this.lastView.onHide(),this.curView.onShow()})},getView:function(t,i){var e=this.views.get(t),s=new n;return e?(e.setHashData(i),s.resolve(e)):this.loadView(t,function(e){var a=new e(t,i,this,this.app);this.viewport.append(a.getRoot()),a.emit("addframe"),this.views.push(t,a),a.onCreate(),s.resolve(a)}),s},loadView:function(t,i){var e=this.buildFullPath(t),s=this;seajs.use([e],function(t){i.call(s,t)})},buildFullPath:function(t){return(this.viewpath+"/"+t).replace(/\/+/g,"/")+".js"},transferView:function(t,i,e){this.hashdata.forward?this.transtion.into(t.getRoot(),i.getRoot(),function(){e.call(this)},this):this.transtion.out(t.getRoot(),i.getRoot(),function(){e.call(this)},this)},forward:function(t){var i=r.parse(t);i.frame&&i.frame!==this.name||this.hashChange(i)},back:function(){history.back()},toHead:function(t,i){this.header.to(t,i)},showToast:function(t,i,e){b().show({content:t,timeout:i,callback:e})},hideToast:function(){b().hide()},showAlert:function(t,i,e){g().show({title:t||"标题",content:i||"",buttons:e})},hideAlert:function(){g().hide()},showLoading:function(t){x().show({maskOpacity:t})},hideLoading:function(){x().hide()}});return L});
...
define("mvc/header.js",["mvc/block","mvc/transition.header"],function(n){var i=n("mvc/block"),t=n("mvc/transition.header");return i.extend({propertys:function(){this.transition=t},initialize:function($super,n){$super(n)}})});
