...
define("mvc/block.js",["base/base","common/funs","base/event","mvc/transition.header.notanimte"],function(t){function e(t){var e=(t||"").replace(/^\s+|\s+$/g,"").split(/\s+/);return{event:e.shift(),selector:e.join(" ")}}function i(t,i,s){t=t||{},n.each(t,function(t,o){var a=e(o),t=n.bind("function"==typeof t?t:noop,s||this);i.on(a.event,a.selector,t)},this)}var n=t("base/base"),s=t("common/funs"),o=t("base/event"),a=t("mvc/transition.header.notanimte"),r=(s.createAddSelf(1500),"cur-block-view"),c="block-view";return o.extend({propertys:function(){this.frame,this.box,this.forward=!1,this.views={},this.transition=null},getPreFix:function(){return"block"},initialize:function($super,t){$super(t),this.setOption(t)},setOption:function(t){t=t||{},n.isNUL(t.box)||(this.box=t.box),n.isNUL(t.frame)||(this.frame=t.frame)},to:function(t,e){e=e||{};var n=this.getPreFix()+t,s=this.box.find("#"+n);s.length||(s=$('<div class="'+c+'" id="'+n+'"></div>'),this.box.append(s)),e.cls&&s.addClass(e.cls);var o=e.notAnimte||!1;if(e.template){var f=e.data||{},l=_.template(e.template)(f);s.html(l),e.events&&(s.off(),i(e.events,s,e.space));var h=o||!this.transition?a:this.transition,d=s.siblings("."+r);if(d.length){var v=this.forward?h.into:h.out;d.width()&&d.height()?v(d,s,function(){d.removeClass(r),s.addClass(r)}):(v(d,s,function(){}),d.removeClass(r),s.addClass(r))}else s.addClass(r)}},getRoot:function(){return this.box},setForward:function(t){this.forward=t}})});
define("mvc/frame.js",["base/base","base/event","base/hash","base/promise","common/funs","common/url.hash","mvc/header","mvc/transition.default","mvc/transition.notanime","ui/dialog","ui/toast","ui/loading"],function(i,t,e){var s=i("base/base"),a=i("base/event"),n=i("base/hash"),o=i("base/promise"),h=i("common/funs"),r=i("common/url.hash"),d=i("mvc/header"),w=i("mvc/transition.default"),u=i("mvc/transition.notanime"),f=i("ui/dialog"),c=i("ui/toast"),l=i("ui/loading"),m="single-frame-box",v="single-frame-head",V="single-frame-viewport",p="single-frame-foot",g=['<div class="'+m+'">','<div class="'+v+'"></div>','<div class="'+V+'">',"</div>",'<div class="'+p+'"></div>',"</div>"].join(""),b=h.createSingle(c),L=h.createSingle(f),x=h.createSingle(l),S=a.extend({propertys:function(){this.app,this.root=$(g),this.viewhead=this.root.find("."+v),this.viewport=this.root.find("."+V),this.viewfoot=this.root.find("."+p),this.header=new d({box:this.viewhead,frame:this}),this.name,this.views=new n,this.hashdata={},this.viewpath="./src/views",this.framebox,this.defaultView="index",this.transtions={"default":w,notanimte:u},this.defaultTranstion="default",this.lastView,this.curView},initialize:function($super,i){$super(),this.setOption(i),this.initDom(),this.app.config.hideHeader&&this.header.hide()},setOption:function(i){s.isNUL(i.app)||(this.app=i.app),s.isNUL(i.name)||(this.name=i.name),s.isNUL(i.viewpath)||(this.viewpath=i.viewpath),s.isNUL(i.framebox)||(this.framebox=i.framebox),s.isNUL(i.defaultView)||(this.defaultView=i.defaultView),s.isNUL(i.transtions)||s.mix(this.transtions,i.transtions),s.isNUL(i.defaultTranstion)||(this.defaultTranstion=i.defaultTranstion)},getRoot:function(){return this.root},initDom:function(){this.framebox.append(this.root)},hashChange:function(i){i.view||(i=new r(this.defaultView)),this.hashdata=i,this.header.setForward(this.hashdata.forward),this.toView(i.view,i)},toView:function(i,t){var e=this;this.getView(i,t).then(function(i,t,s){e.lastView=e.curView||s,e.curView=s,s.emit("onLoadBefore",e.lastView.hashdata.view),s.onLoad(e.lastView.hashdata.view),s.emit("onLoadAfter",e.lastView.hashdata.view)})},turning:function(i){var t=this.lastView||this.curView;this.curView===this.lastView?(this.curView.getRoot().show(),this.curView.emit("onShowBefore",t.hashdata.view),this.curView.onShow(t.hashdata.view),this.curView.emit("onShowAfter",t.hashdata.view)):this.transferView(i,this.lastView,this.curView,function(){this.lastView.emit("onHideBefore"),this.lastView.onHide(),this.lastView.emit("onHideAfter"),this.curView.emit("onShowBefore",t.hashdata.view),this.curView.onShow(t.hashdata.view),this.curView.emit("onShowAfter",t.hashdata.view)})},getView:function(i,t){var e=this.views.get(i),s=new o;return e?(e.setHashData(t),s.resolve(e)):this.loadView(i,function(e){if(!e)throw new Error("not found `"+i+".js`");var a=new e(i,t,this,this.app);this.viewport.append(a.getRoot()),a.emit("addframe"),this.views.push(i,a),a.onCreate(),s.resolve(a)}),s},loadView:function(i,t){var e=this.buildFullPath(i),s=this;seajs.use([e],function(i){t.call(s,i)})},getCurrentView:function(){return this.curView||this.lastView},buildFullPath:function(i){return(this.viewpath+"/"+i).replace(/\/+/g,"/")+".js"},transferView:function(i,t,e,s){i=i||this.defaultTranstion;var a=this.transtions[i]||w;this.hashdata.forward?a.into(t.getRoot(),e.getRoot(),function(){s.call(this)},this):a.out(t.getRoot(),e.getRoot(),function(){s.call(this)},this)},forward:function(i){var t=r.parse(i);t.frame&&t.frame!==this.name||this.hashChange(t)},back:function(){history.back()},toHead:function(i,t){this.header.to(i,t)},showToast:function(i,t,e){b().show({content:i,timeout:t,callback:e})},hideToast:function(){b().hide()},showAlert:function(i,t,e,s){L().show({title:e||"标题",content:i||"",buttons:t,hideTitle:!s})},hideAlert:function(){L().hide()},showLoading:function(i){x().show({maskOpacity:i})},hideLoading:function(){x().hide()},showHeader:function(){this.header.show()},hideHeader:function(){this.header.hide()}});return S});
