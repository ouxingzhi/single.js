...
define("common/audioplay.js",["base/event"],function(t){function i(t,i,s,e){t.addEventListener(i,s,e)}var s=t("base/event"),e=s.extend({propertys:function(){this.status=e.STATUS_STOP,this.audio=document.createElement("audio")},initialize:function($super,t){$super(t),this._setOption(t),this._initEvents()},_setOption:function(t){t=t||{},t.src&&(this.src=t.src)},_initEvents:function(){var t=this.audio;i(t,"loadstart",this),i(t,"progress",this),i(t,"suspend",this),i(t,"abort",this),i(t,"error",this),i(t,"stalled",this),i(t,"play",this),i(t,"pause",this),i(t,"loadedmetadata",this),i(t,"loadeddata",this),i(t,"waiting",this),i(t,"playing",this),i(t,"canplay",this),i(t,"canplaythrough",this),i(t,"seeking",this),i(t,"seeked",this),i(t,"timeupdate",this),i(t,"ended",this),i(t,"ratechange",this),i(t,"durationchange",this),i(t,"volumechange",this)},handleEvent:function(t){switch(t.type){case"play":this.status=e.STATUS_PLAY;break;case"pause":this.status=e.STATUS_PAUSE;break;case"stalled":case"waiting":this.status=e.STATUS_LOADING;break;case"ended":case"abort":this.status=e.STATUS_STOP;break;case"error":this.status=e.STATUS_ERROR}this.emit(t.type,arguments),this.emit("all",arguments)},play:function(){this.audio.play()},pause:function(){this.audio.pause()},getStatus:function(){return this.status},setSrc:function(t){this.audio.src=t},getSrc:function(){return this.audio.src},getRealSrc:function(){return this.audio.getAttribute("src")},getLength:function(){return this.audio.duration},getCurPos:function(){return this.audio.currentTime},setTitle:function(t){return this.audio.title=t},getTitle:function(){return this.audio.title}});return e.STATUS_STOP="stop",e.STATUS_PLAY="play",e.STATUS_LOADING="loading",e.STATUS_PAUSE="pause",e.STATUS_ERROR="error",e});
...
define("common/lrcview.js",["common/lrc","ui/base"],function(t){var i=t("common/lrc"),s=t("ui/base"),e=i.extend({propertys:function(){this.wraper,this.box,this.offset=0,this.subbox},initialize:function($super,t){$super(t),this._initDom();var i=function(){this._stopAnima(),this._updateLrcDom(),this.pos(0);var t=this;setTimeout(function(){t._startAnima()},0)}.bind(this);this.on("update",i),i()},_setOption:function($super,t){$super(t),t.wraper&&(this.wraper=t.wraper),t.offset&&(this.offset=t.offset)},_initDom:function(){this.box=$("<div>"),this.box.css({width:"100%",height:"100%",position:"relative"}),this.subbox=$("<ul>"),this.subbox.css({width:"100%",position:"absolute",left:"0px",top:"0px"}),this.box.append(this.subbox),this.wraper.empty(),this.wraper.append(this.box)},_stopAnima:function(){this.subbox.removeClass("bottonbanner-fixed-anima")},_startAnima:function(){this.subbox.addClass("bottonbanner-fixed-anima")},_updateLrcDom:function(){this.subbox.empty();var t=this.getLrc();if(t&&t.lines)for(var i,s=t.lines,e=0,o=s.length;o>e;e++)i=s[e],this.subbox.append($("<li>"+i.line+"</li>").attr("data-time",i.time).attr("data-id",i.id))},_addMetaInfo:function(t,i){var s=t[0].time,e=s/4;if(i.ti)for(var o=["ti","ar","al"],n=["歌名","歌手","专辑"],a=2;a>-1;a--)t.unshift({time:1+e*a,line:n[a]+":"+(i[o[a]]||""),id:+new Date+String(Math.random()).replace(".","")})},pos:function($super,t){var i=this.box.height()/2,e=$super(t);if(e){var o=this.subbox.find('[data-id="'+e.id+'"]');o.siblings().removeClass("cur"),o.addClass("cur"),o.length&&s.setTranslate(this.subbox,{x:"0px",y:-o[0].offsetTop+i-o.height()/2+this.offset+"px"})}},setOffset:function(t){this.offset=t},getOffset:function(){return this.offset}});return e});
