	...
	var I = function(){
		...
		function init(){
			if(!d){
				...
				d.style.cssText = 'z-index:8000;color:#fff;position:absolute;left:0px;bottom:0px;width:100%;height:3em;font-size:12px;background:rgba(0,0,0,0.8);padding:10px 0px;';
			}
			return d;
		}
		return {
