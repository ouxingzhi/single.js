define(['Base','BaseEventObject','BaseHash','Promise','CommonUrlHash','MvcTransitionDefault'],function(Base,BaseEventObject,BaseHash,Promise,CommonUrlHash,MvcTransitionDefault){
	...
	var Frame = BaseEventObject.extend({
		...
		loadView:function(viewname,callback){
			var fullpath = this.buildFullPath(viewname),
				self = this;
			requirejs([fullpath],function(View){
