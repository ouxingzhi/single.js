define(['MvcTransitionInterface'],function(MvcTransitionInterface){

	var TRANS_FORWARD_OUT = 'default_forward_out',
		TRANS_FORWARD_IN = 'default_forward_in',
		TRANS_BACK_OUT = 'default_back_out',
		TRANS_BACK_IN = 'default_back_in';
